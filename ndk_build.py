...
if '__main__' == __name__:
    ...
    for abi in abiList:
        ...
        -DENABLE_PROGRAMS=0 \
        -DINSTALL_MBEDTLS_HEADERS=0 \
        -DENABLE_TESTING=0 \
         ..'''%(ANDROID_CMAKE,abi,ANDROID_NDK,ANDROID_NDK,ANDROID_NINJA ) 
        ...
        shutil.move(os.path.join(buildDir, "libYNet.a"),os.path.join(outSoPath, "libYNet.a"))
        shutil.move(os.path.join(buildDir, "example"),os.path.join(outSoPath, "example"))